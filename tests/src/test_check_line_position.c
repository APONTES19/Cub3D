...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/12 03:21:01 by ryoshio-          #+#    #+#             */
/*   Updated: 2023/02/12 03:35:06 by ryoshio-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/tests.h"

static void test_check_line_position_wrong_failure(void);
static void test_check_line_position_correct_success(void);

void test_check_line_position(void)
{
	printf("\n==============================================\n");
	printf("\n\033[0;36mTest check_line_position ;\033[0m\n\n");
	test_check_line_position_wrong_failure();
	test_check_line_position_correct_success();
	printf("\n==============================================\n");
}
...
static void test_check_line_position_wrong_failure(void)
{
	...
	char path[] = {"./maps/check_line_position/" };
	...
	while(file[i][0] != '\0')
	{
		...
		result = ft_check_line_position(text);
		if (result == FAILURE)
